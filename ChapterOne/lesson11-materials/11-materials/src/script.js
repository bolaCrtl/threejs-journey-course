...
const material = new THREE.MeshStandardMaterial({roughnessMap: doorRoughnessTexture, metalnessMap: doorMetalnessTexture, map: doorColorTexture, aoMap: doorAmbientOcclusionTexture, aoMapIntensity: 1})
